    ...
    <div class="container-fluid">
        <div class="row display-table">
			...
			<div class="tab">
					...
					<form name="registration" action="addmember.php" method="post" enctype="multipart/form-data">
                    <div class="col-md-6 photo-up-height">
                         ...
                         <div  class="form-group photo-up text-center">
                            <label id="imageUploadLabel" style="line-height:1.3em;margin-top:30px; letter-spacing:0.1em;" for="photo-up">UPLOAD <br> SELF <br> PHOTO</label>
...
<a href="email/index.php"><img alt="xyz" class="img-responsive" src="images/logo email1.png" style="position:relative; width:700px;margin-top:-35px; margin-left: 32px;" /> </a>
	...
	<li> <input maxlength="1" type="text" style="color: #EFE187;margin-top: -70px;margin-left: 290px; width: 30px; height: 30px; background-color:transparent;padding-left:0px;" placeholder="" /></li>
                        ...
                        <div class="click-button text-center">
                          <button class="my-btn btn btn-default" type="submit" name="submit">SAVE</button>
                        </div>
					</form>
					</div>
